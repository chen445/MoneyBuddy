        ...
        return (
            <div>
                <form onSubmit={this.handleClick}>
                    ...
                    <button type="submit" value={this.state.type} onClick={this.update("type")}>Report Income</button>
                    <button type="submit" value={this.state.type} onClick={this.update("type")}>Report Expense</button>
                </form>
            </div>
        );
    }
