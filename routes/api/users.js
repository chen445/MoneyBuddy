...
const model_constants = require("../../models/Constants");
              ...
              newUser
                ...
                .then((user) => {
                  ...
                  const payload = {
                    ...
                    icons: model_constants.DEFAULT_ICONS,
                    point: model_constants.DEFAULT_POINT,
                    firstLogin: true,
                  };
  ...
  (req, res) => {
    User.findById(req.user.id).then((user) => {
      if (user.point >= req.body.point) {
        ...
        return res.json(
          `You need ${req.body.point} points to make this purchase!`
        );
      }
    });
  }
